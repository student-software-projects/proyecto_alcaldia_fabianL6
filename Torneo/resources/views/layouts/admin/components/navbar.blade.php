                            ...
                            <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12">
                                <div class="header-top-menu tabl-d-n hd-search-rp">
                                    <div class="breadcome-heading">
                                        <div class="col-md-2">
                                            <h4><a  class="text-white my-auto " href="{{route('dashboard.index')}}"> Inicio</a></h4>
                                        </div>"
                                        <div class="col-md-2 mr-3" >
                                            <h4><a  class="text-white my-auto" href="{{route('dashboard.index')}}"> Servicios</a></h4>
                                        </div>
                                        <div class="col-md-2" >
                                            <h4 ><a class="text-white my-auto" href="{{route('dashboard.index')}}"> Contactanos</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                <div class="header-right-info">
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle mr-3">

                                                <span class="admin-name">Configuracion</span>
                                            </a>
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                <li><a href="{{route('dashboard.perfil')}}"><i class="fas fa-user-astronaut"></i> Mi perfil</a>
                                                </li>
                                                <li><a href="{{route('login.logout')}}"><i class="fas fa-sign-out-alt"></i> Cerrar sesion</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>BIENVENIDO A TORNEO SENA</h2>
                                        <p> <span class="bread-ntd">Inicio / Administrador</span> </p>
                                    </div>
                                </div>
                            </div>
                            </div>
